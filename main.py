...
weapon_datas = [
    ...
    Weapon(name="转换者", one_damage=16, weapon_type="冲锋枪", capacity=[19, 22, 25, 27],
    ...
    Weapon(name="转换者(干扰子弹)", one_damage=16, disruptor=0.2, weapon_type="冲锋枪", capacity=[19, 22, 25, 27],
           shoot_time=[1, 102, 202, 304, 399, 504, 599, 703, 814, 904, 1019, 1104, 1207, 1303, 1418, 1502, 1599,
                       1702, 1807,
                       1922, 2018, 2122, 2218, 2303, 2418, 2502, 2618]),
    Weapon(name="RE45", one_damage=12, weapon_type="冲锋枪", capacity=[16, 19, 22, 25],
           shoot_time=[1, 86, 150, 238, 304, 387, 474, 535, 619, 686, 788, 855, 935, 999, 1086, 1152, 1236, 1322,
                       1387, 1474,
                       1534, 1619, 1702, 1786, 1854]),
    Weapon(name="RE45(锤击点)", one_damage=12, hammer_point=0.35, weapon_type="冲锋枪", capacity=[16, 19, 22, 25],
           shoot_time=[1, 86, 150, 238, 304, 387, 474, 535, 619, 686, 788, 855, 935, 999, 1086, 1152, 1236, 1322,
                       1387, 1474,
                       1534, 1619, 1702, 1786, 1854]),
    ...
    Weapon(name="复仇女神", one_damage=16, weapon_type="步枪",
           capacity=[20, 24, 28, 32],
           shoot_time=[1, 54, 102, 170, 455, 504, 571, 619, 904, 952,
                       999, 1074, 1322, 1387, 1434, 1486, 1722, 1786, 1834, 1902,
                       2103, 2170, 2218, 2270, 2470, 2538, 2587, 2634, 2818, 2884,
                       2938, 2989]),

    Weapon(name="复仇女神(充能)", one_damage=16, weapon_type="步枪",
           capacity=[20, 24, 28, 32],
           shoot_time=[1, 66, 122, 183, 371, 420, 487, 535, 703, 771,
                       814, 886, 1056, 1123, 1171, 1219, 1398, 1474, 1522, 1570,
                       1750, 1819, 1866, 1922, 2103, 2170, 2206, 2254, 2434, 2502,
                       2551, 2618]),
    ...
    Weapon(name="暴走(充能)", one_damage=26, weapon_type="机枪",
           capacity=[28, 32, 34, 40],
    ...
    Weapon(name="lstar", one_damage=17, weapon_type="机枪",
           ...
           shoot_time=[1, 122, 218, 323, 420, 504, 559, 703, 799, 904,
                       988, 1086, 1171, 1255, 1350, 1454, 1534, 1634, 1734, 1834,
                       1922, 2018, 2122, 2218, 2322, 2418, 2502, 2606, 2702, 2806,
                       2884]),

    Weapon(name="哈沃克", one_damage=18, weapon_type="步枪",
           capacity=[24, 28, 32, 36],
           shoot_time=[387, 487, 571, 656, 751, 838, 923, 999, 1086, 1171,
                       1255, 1350, 1434, 1522, 1599, 1682, 1771, 1866, 1950, 2034,
                       2122, 2206, 2282, 2386, 2470, 2551, 2634, 2719, 2806, 2884,
                       2970, 3054, 3138, 3222, 3318, 3406]),

    Weapon(name="哈沃克(涡轮)", one_damage=18, weapon_type="步枪",
           capacity=[24, 28, 32, 36],
           shoot_time=[1, 102, 183, 274, 352, 438, 523, 599, 686, 771,
                       868, 952, 1038, 1123, 1207, 1286, 1387, 1474, 1550, 1634,
                       1722, 1807, 1902, 1986, 2070, 2150, 2254, 2338, 2418, 2502,
                       2587, 2671, 2751, 2835, 2938, 3006]),

    Weapon(name="专注", one_damage=15, weapon_type="机枪",
           capacity=[36, 40, 44, 48],
           shoot_time=[1, 202, 352, 487, 619, 723, 838, 923, 1019, 1104,
                       1207, 1274, 1334, 1398, 1486, 1550, 1619, 1682, 1750, 1819,
                       1866, 1934, 2006, 2070, 2134, 2206, 2270, 2338, 2406, 2454,
                       2522, 2587, 2654, 2719, 2786, 2835, 2902, 2970, 3034, 3102,
                       3170, 3222, 3282, 3350, 3418, 3483, 3538, 3618]),

    Weapon(name="专注(涡轮)", one_damage=15, weapon_type="机枪",
           capacity=[36, 40, 44, 48],
           shoot_time=[1, 150, 274, 371, 474, 552, 638, 703, 771, 838,
                       904, 971, 1038, 1104, 1171, 1219, 1286, 1350, 1418, 1486,
                       1550, 1619, 1666, 1734, 1807, 1866, 1922, 1986, 2054, 2122,
                       2186, 2235, 2303, 2370, 2434, 2502, 2570, 2634, 2702, 2770,
                       2818, 2884, 2951, 3022, 3082, 3150, 3222, 3270]),
]
...
class TimePointDamage(QMainWindow):
    ...
    def plot_data(self, shielded, weapon_type, reduce=0, early_termination=False, capacity_type_index=3):
        ...
        self.ax.xaxis.set_major_locator(MultipleLocator(200))
